...
export const products: Product[] = [
  ...
  {
    id: 36,
    name: "LUMINÁRIA DE MESA EM METAL",
    brand: "Design Minimalista",
    price: "R$ 110",
    image: "/lum1.png",
     description:"Peça com visual industrial e acabamento sofisticado! Ideal pra escritório, home office ou decoração moderna.",
     features: [
      "Estrutura em metal resistente",
      "Ajustável na altura e inclinação",
      "Funciona perfeitamente",
  ...
  {
    id: 38,
    name: "Chapa de Hambúrguer a Gás",
    brand: "Funcionando perfeitamente",
    price: "R$ 650",
    image: "/chapa.png",
     description:"Chapa de hambúrguer excelente para o seu estabelecimentou o sua casa",
     features: [
      "Estrutura reforçada em inox",
      "Funcionando perfeitamente",
      "Ideal para lanches, hambúrgueres, carnes e grelhados",
      "Ótima para quem quer montar ou ampliar seu negócio de alimentação",
    ],
  },
  {
    id: 39,
    name: "Mesa redonda dobrével",
    brand: "Funcionando perfeitamente",
    price: "R$ 120",
    image: "/mesab1.png",
     description:"Essa é uma mesa redonda dobrável com tampo de madeira MDF e estrutura de ferro pintado de branco",
     features: [
      "Tampo de madeira MDF resistente",
      "Estrutura dobrável em ferro branco",
      "Compacta, prática e fácil de guardar",
      "Ideal para varandas, áreas de lazer, cafés ou apartamentos",
    ],
  },
  {
    id: 29,
